...
const linkForgeSettings = () => {
    return (
     <>
        <div className={styles.page_full_handle}>
            <div className="pu_container">
                <div className={styles.pu_wr}>
                    <h3 className={styles.page_heading}>LinkForge Settings</h3>
                    <div className={styles.page_handle}>
                        ...
                        <a > LinkForge Settings </a>
                    </div>
                </div>
            </div>
        </div>
        <div className="pu_container">
            <div className={`${styles.help_main}`}> 
                <Link href="/help/linkforge-settings/customize-theme"><a>How to customize LinkForge theme</a></Link>
                <Link href="/help/linkforge-settings/setup-social-links"><a>How to setup social links</a></Link>
                <Link href="/help/linkforge-settings/change-icon-theme"><a>How to change social icon theme</a></Link>
                <Link href="/help/linkforge-settings/change-template"><a>How to change LinkForge template</a></Link>
                <Link href="/help/linkforge-settings/seo-settings"><a>LinkForge SEO settings</a></Link>
            </div>
        </div>
        </>
...
export default linkForgeSettings;