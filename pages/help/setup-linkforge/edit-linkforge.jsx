...
const editLinkForge = () => {
    return (
            ...
            <div className={styles.page_full_handle}>
                <div className="pu_container">
                    <div className={styles.pu_wr}>
                        <h3 className={styles.page_heading}>Edit LinkForge </h3>
            ...
            <div className="pu_container">
                <div>
                    <p>edit linkforge is simply dummy text of the printing and typesetting industry.
